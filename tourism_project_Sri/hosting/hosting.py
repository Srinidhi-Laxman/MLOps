...
api.upload_folder(
    folder_path="tourism_project_Sri/deployment",         # local folder containing app.py + requirements.txt
    repo_id="Srinidhiiiiii/visit-with-us-wellness",  # 🚨 your HF Space name
