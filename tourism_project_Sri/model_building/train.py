...
HF_DATASET_REPO = "Srinidhiiiiii/Tourism-Project"
...
# -------------------------
mlflow.set_tracking_uri("file:///tmp/mlruns")   # local file-based tracking
...
with mlflow.start_run():
    ...
    # Log classification metrics (train & test) to MLflow
    try:
    ...
    try:
        ...
        print("Warning: failed to log artifact to MLflow:", e)

# -------------------------
# Upload saved model to Hugging Face Model Hub (new model repo)
# -------------------------
repo_id = "Srinidhiiiiii/visit-with-us-wellness-xgb"
repo_type = "model"
